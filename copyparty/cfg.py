...
flagcats = {
    ...
    "database, general": {
        ...
        "hist_cow": "btrfs: keep copy-on-write enabled on db/thumbs",
    ...
    "thumbnails": {
        ...
        "dvcode": "disables on-the-fly video transcoding (HLS)",
        "vt_maxh=720": "max height of transcoded video (0=source)",
        "vt_vq=23": "h264 quality (crf) for transcoded video; lower=better",
        "vt_preset=veryfast": "x264 speed/efficiency preset",
        "vt_enc=auto": "transcode encoder: auto/x264/vt/nvenc/qsv/amf",
    ...
    "client and ux": {
        ...
        "nomime": "disallow ?mime to change response type",
